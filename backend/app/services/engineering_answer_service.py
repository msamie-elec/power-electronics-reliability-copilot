...
class EngineeringAnswerService:
    def answer_question(
        ...
        logger.info("Building engineering answer for document_id=%s", document_id)
        ...
        try:
            ...
            logger.info(
                "Prepared evidence for document_id=%s semantic=%s graph_entities=%s graph_relationships=%s",
                document_id,
